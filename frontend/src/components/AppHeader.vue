    ...
    <div class="page-container h-16 flex items-center gap-4">
      ...
      <div class="flex items-center gap-1 flex-shrink-0">
        ...
        <UserAccountMenu
          ...
          :vip-expires-at="vipExpiresAt"
          :ai-usage-today="aiUsageToday"
          :ai-daily-limit="aiDailyLimit"
          @renew-vip="$emit('renew-vip')"
          @logout="$emit('logout')"
        />
...
defineEmits(['login', 'logout', 'renew-vip', 'history', 'menu-open', 'navigate', 'new-parse', 'upload-local'])
