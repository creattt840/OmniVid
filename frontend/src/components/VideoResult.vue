  ...
  <div class="animate-fade-up bg-bg-card rounded-3xl border border-border-light shadow-sm overflow-hidden">
    ...
    <div class="p-5 sm:p-6">
      ...
      <button
        ...
        class="w-full h-13 flex items-center justify-center gap-2 rounded-full bg-primary hover:bg-primary-dark text-white font-semibold text-base transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-md hover:shadow-lg cursor-pointer"
      >
